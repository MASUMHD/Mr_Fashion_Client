const Testimonials = () => {
  return (
    <div className="mt-10">
      <section className="my-8 dark:bg-gray-100 dark:text-gray-800 rounded-lg">
        <div className="container flex flex-col items-center mx-auto  md:p-10 md:px-12">
          <h1 className="p-4 text-3xl lg:text-4xl font-semibold leading-none text-center">
            What our customers are saying about us
          </h1>
        </div>
        <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10 ">
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-50">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                This smartwatch blends sleek design and excellent performance,
                offering precise fitness tracking, notifications, and
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-50">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                User-friendly interface, stunning display, and durable build make this smartwatch a perfect companion for daily activities.
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  fill="currentColor"
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-50">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                Highly accurate health metrics, versatile features, and stylish design ensure this smartwatch exceeds all expectations effortlessly.
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  fill="currentColor"
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-50">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                From workouts to workdays, this smartwatch delivers unmatched functionality, making it indispensable in every aspect.
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  fill="currentColor"
